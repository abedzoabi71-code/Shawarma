...
const ITEMS = [
  { id:'sh-turkey', cat:'shawarma', price:52, photo:'', tag:L('הכי נמכר','الأكثر طلباً','Best seller'),
    name:L('שווארמה הודו','شاورما ديك رومي','Turkey shawarma'),
    desc:L('חתוכה מהשיפוד, עם שומן כבש קלוי','مقطوعة من السيخ مع دهن الخروف','Carved off the spit, roasted lamb fat') },
  ...
  { id:'sh-mix', cat:'shawarma', price:58, photo:'',
    name:L('שווארמה מיקס','شاورما مشكّلة','Mixed shawarma'),
    desc:L('הודו וכבש יחד','ديك رومي ولحم معاً','Turkey and lamb together') },
  ...
  { id:'pargiot', cat:'grill', price:54, photo:'',
    name:L('פרגיות','فراريج','Chicken thighs'),
    desc:L('במרינדה של הבית','بتتبيلة البيت','House marinade') },
  ...
  { id:'sabich', cat:'falafel', price:38, photo:'',
    name:L('סביח','سبيح','Sabich'),
    desc:L('חציל, ביצה, תפוד','باذنجان وبيض وبطاطا','Aubergine, egg, potato') },
...
const BREADS = [
  ...
  { id:'plate', extra:6, name:L('מגש','صحن','On a plate') },
];

const SALADS = [
  { id:'hummus', photo:'', name:L('חומוס','حمص','Hummus') },
  { id:'tahina', photo:'', name:L('טחינה','طحينة','Tahina') },
  { id:'chips', photo:'', name:L('צ׳יפס','بطاطا','Fries') },
  { id:'pickles', photo:'', name:L('חמוצים','مخلل','Pickles') },
  { id:'cabbage', photo:'', name:L('כרוב','ملفوف','Cabbage') },
  { id:'salat', photo:'', name:L('סלט ירקות','سلطة','Chopped salad') },
  { id:'onion', photo:'', name:L('בצל סומק','بصل سماق','Sumac onion') },
...
const EXTRAS = [
  ...
  { id:'egg', price:5, name:L('ביצה קשה','بيضة مسلوقة','Boiled egg') },
];
...
const T = {
  ...
  heroTitle: L('שווארמה\nמהשיפוד','شاورما\nمن السيخ','Shawarma\noff the spit'),
  heroSub: L('משלוחים לניין, עפולה והסביבה. מזמינים כאן, מקבלים חם.','توصيل لنين والعفولة والمنطقة. اطلب من هون ويوصلك ساخن.','Delivery to Nein, Afula and around. Order here, get it hot.'),
